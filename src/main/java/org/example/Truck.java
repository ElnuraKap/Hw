...
public class Truck  implements  WorkAbl{
    private int id;
    private TruckName name;
    private String driver;
    private State state;



    public Truck(int id, TruckName name, String driver, State state) {
        this.id = id;
        this.name = name;
        this.driver = driver;
        this.state = state;
    ...
    public TruckName getName() {
        return name;
    }

    public void setName(TruckName name) {
        this.name = name;
    }
    ...
    public static Truck makeTruck(int id, TruckName name, String driver, State state){
